...
<head lang="en">
    ...
    <title>ACL > User Management - ACL Electronics Logs Portal</title>
    <!-- CSS only -->
            ...
            <div class="col-md-12">
                <div class="card border-primary">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <form id="formdetails" action="../php/UpdateUser.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">User ID</label>
                                        <input type="text" class="form-control" placeholder="User ID (ACL-XX)" id="uid" name="uid" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="role" name="role">
                                            ...
                                            <option value="Intern Trainee">Intern Trainee Student</option>
                                            <option value="Minor Employee">Minor Employee</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
        ...
        <div class="row" style="padding-top: 5%;">
            <div class="col-md-12">
                <div class="card border-danger">
                    <div class="card-header bg-danger" style="color: #fff;">Delete User Account</div>
                    <div class="card-body text-danger">
                        <h5 class="card-title">Danger Zone!</h5>
                        <p class="card-text">Please enter user ID number:</p>
                        <form action="../php/DeleteUserAccount.php" method="POST">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control border-danger" placeholder="USER ID (Type only number: ACL-XX)" id="userid" name="userid" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-danger" style="width: 100%; color: #fff;" value="Delete User"></input>
                                    </div>
                                </div>
                            </div>
                        </form>
