...
<body>
    ...
    <div class="container" style="padding-top: 5%;">
        <div class="card border-info">
            <div class="card-header bg-info" style="color: #fff;">ACL Electronics - Machine List!</div>
    ...
    <div class="container" style="padding-top: 5%;">
        <div class="row">
            <div class="col-md-12">
                <div class="card border-info">
                    <div class="card-header bg-info" style="color: #fff;">ACL Electronics - Update Machine Detail!</div>
                    <div class="card-body text-info">
                        <div class="row" style="text-align: center; color: #4C4B4B;">
                            <div class="col" style="text-align: left;">
                        ...
                        <form action="../php/UpdateMachine.php" method="POST">
                            ...
                            <div class="row" style="padding-top: 5%;">
                                <div class="col-md-12" style="text-align: end;">
                                    <input type="submit" class="btn btn-info" style="color: #fff;" value="Update Machine Details"></input>
